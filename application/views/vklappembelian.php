	...
	<div class="container-fluid">
		<div class="card card-default">
			<div class="card-header">
				<h3 class="card-tittle">Laporan Pembelian</h3>
				...
				<div class="toolbar" >
					...
					<div class="row h-75 justify-content-center">
						...
						<div class="col-sm-12 text-center">
							<a href="<?php echo base_url().'klaporan/pembelian'?>" class="btn btn btn-default border border-12">Reset Filter</a>
							<button type="submit" id="btn-loading" class="btn btn-main"> <i ></i>Tampil</button>
						</div>
					</div>
				</form><br><br>	
					...
					<table id="dt" class="table table-striped" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th width="100">No Invoice Pembelian</th>
						...
						<tbody >
                 			<?php
        						...
        						echo "<td class=uang-indo>".$data->harga."</td>";
        						echo "<td><a href=".base_url().'nota/pembelian/'."".$data->nopembelian." class='btn-sm btn-info btn-sm'><i class='fa fa-print'></i> Cetak Nota</a></td>";
        						echo "</tr>";
        						$no++;
      								}
    							}
