				...
				<form class="form-horizontal" id="myForm" name="form">
					<div class="row h-75 justify-content-center">
						...
						<div class="col-sm-5 col-sm-offset-1" >
							...
							<div class="form-group row">
								<label for="sisa" class="col-form-label col-sm-3 text-sm-right text-left" >Sisa Utang(Rp)</label>
								<div class="col-sm-9">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" name="status" id="status" min="0" value="" class="form-control " disabled>
									<small class="help-block"></small>
								</div>
							</div>
								<div class="form-group row">
								<label for="tglbayar" class="col-form-label col-sm-3 text-sm-right text-left ">Tanggal Pembayaran</label>
								<div class="col-sm-9">
