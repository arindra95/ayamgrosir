	...
	<div class="container-fluid">
		<div class="card card-default " id="form-edit" style="display: none">
			<div class="card-header">
				<h3 id="tittle" class="card-tittle pull-left">Tambah data pelanggan baru</h3>
					...
					<div class="row h-75 justify-content-center">
						<div class="col-sm-5 col-sm-offset-1" >
							...
							<div class="form-group row">
								<label for="namapel" class="col-sm-3 col-form-label text-sm-right text-left" style="">Nama Pelanggan</label>
								<div class="col-sm-9">
									<input type="text" id="namapel" value="" class="form-control" required>
		...
		<div class="card card-default">
			...
			<div class="card-body">
				...
				<div class="table-responsive">
					<table id="peltable" class="table table-hover" cellspacing="0" width="100%">
						<thead>
							<tr>
...
<script>
	...
	$(document).ready(function(){
		...
		$('peltable td').css('white-space','initial');
		var table = $("#peltable").DataTable({

			"ajax": {
				"url" : "<?php echo base_url().'pelanggan/load_pelanggan'?>",
		...
		$('#peltable tbody').on( 'click', 'tr', function(){
    		$("#peltable tbody tr").removeClass('selected');
		...
		btnCreate.on('click', function(){
		 	//save_method = 'add';
		 	$("#tittle").text("Tambah data pelanggan baru");
		 	resetForm();
			data=null;
			openForm();
    	...
    	//closeForm();
    		//save_method = 'update';
    		$("#tittle").text("Ubah data pelanggan");
    		...
    		openForm();
			url = '<?php echo base_url().'pelanggan/perbarui/'?>'+data.idpelanggan;
		});
