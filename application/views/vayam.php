...
<section class="main-wrapper">
	<div class="container-fluid">
					...
					<div class="row h-75 justify-content-center">
						<div class="col-sm-5 col-sm-offset-1" >
							...
							<div class="form-group row">
								<label for="id" class="col-sm-3 col-form-label text-sm-right text-left" style="">Kode Ayam</label>
								<div class="col-sm-9">
							...
							<div class="form-group row" >
								<label for="jenis" class="col-form-label col-sm-3 text-sm-right text-left">Jenis Ayam</label>
								<div class="col-sm-9">
		...
		<div class="card card-default">
			<div class="card-header">
				<h3 class="card-title">Jenis Ayam </h3>
			</div>
			<div class="card-body">
				...
				<div class="table-responsive">
					<table id="ayamtable" class="table table-hover" cellspacing="0" width="100%">
						<thead>
							<tr>
...
<script>
	...
	$(document).ready(function(){
		...
		$('ayamtable td').css('white-space','initial');
		var table = $("#ayamtable").DataTable({

			"ajax": {
				"url" : "<?php echo base_url().'ayam/load_ayam'?>",
		...
		$('#ayamtable tbody').on( 'click', 'tr', function(){
    		$("#ayamtable tbody tr").removeClass('selected');
		...
		btnCreate.on('click', function(){
		 	//save_method = 'add';
		 	$("#tittle").text("Tambah data jenis ayam baru");
		 	resetForm();
			data=null;
			openForm();
			url = '<?php echo base_url().'ayam/simpan'?>';
			reloadData();
		});
    	...
    	//closeForm();
    		//save_method = 'update';
    		$("#tittle").text("Ubah data jenis ayam");
  			kd.val(data.id);
  			jns.val(data.jenis);
    		...
    		openForm();
			url = '<?php echo base_url().'ayam/perbarui/'?>'+data.id;
		});
		...
		btnDelete.on('click', function(){
			if(data.id != ''){
				...
				if(hapus){
					...
					$.ajax({
						url: "<?php echo base_url().'ayam/hapus'?>",
						type: "POST",
						data: "id="+data.id,
						beforeSend:function(){
