					...
					<div class="row h-75 justify-content-center">
						...
						<div class="col-sm-5 col-sm-offset-1" >
							...
							<div  class="form-group row">
								...
								<div class="col-sm-9">
										<select id="idsupplier" class="form-control"  style="width: 100%">
						...
						<div class="col-sm-5 ">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" name="harga" value="" id="harga" maxlength="15" class="uang-indo form-control " required="">
									<small class="help-block"></small>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" name="hargabeli" id="hargabeli" value="" class="uang-indo form-control" ></input>
									<small class="help-block"></small>
								</div>
							</div>
						</div>
