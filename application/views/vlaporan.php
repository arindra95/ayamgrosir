	...
	<div class="container-fluid">
		<div class="card card-default">
			<div class="card-header">
				<h3 class="card-tittle">Laporan Penjualan</h3>
				...
				<div class="toolbar" >
					...
					<div class="row h-75 justify-content-center">
						...
						<div class="col-sm-12 text-center">
							<a href="<?php echo base_url().'laporan/penjualan'?>" class="btn btn btn-default border border-12">Reset Filter</a>
					...
					<table id="dt" class="table table-striped" cellspacing="0" width="100%">
						...
						<tbody >
                 			<?php
        						...
        						echo "<td><a href=".base_url().'nota/penjualan/'."".$data->noinvoice." class='btn-info btn-sm' align='right'><i class='fa fa-print'></i> Cetak Nota</a></td>";
        						echo "</tr>";
            			...
            			<tfoot>
            				<?php
        						...
        						echo "<td class=uang-indo colspan=1 align=right>".$total->total."</td>";
        						echo "</tr>";
    							}
    						}
    						?>
            				<!--<?php
        						...
        						//echo "<tr>";
        						//echo "<td colspan=6 align=right>Total Penjualan :</td>";
		...
		<script type="text/javascript">
			var btnFilter = $("#btn-filter").DataTable({
