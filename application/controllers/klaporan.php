<?php 
	 ...
	 * 
	 */
	class klaporan extends CI_Controller
	{
		...
		public function penjualan(){
            ...
            if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                ...
                $ket = 'Laporan Penjualan pada Tanggal '.date('d-m-y', strtotime($tgl));
                $url_cetak = 'klaporan/cetakp?filter=1&tanggal='.$tgl;
                $url_cetak1 = 'klaporan/cetakpenjualan?filter=1&tanggal='.$tgl;
                ...
                $url_cetak = 'klaporan/cetakp?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                $url_cetak1 = 'klaporan/cetakpenjualan?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                ...
                $url_cetak = 'klaporan/cetakp?filter=3&tahun='.$tahun;
                $url_cetak1 = 'klaporan/cetakpenjualan?filter=3&tahun='.$tahun;
                $transaksi = $this->mlaporan->view_by_year($tahun)->result(); // Panggil fungsi view_by_year yang ada di TransaksiModel
            }
        }else{ // Jika user tidak mengklik tombol tampilkan
            $ket = 'Semua Data Transaksi';
            $url_cetak = 'klaporan/cetakp';
            $url_cetak1 = 'klaporan/cetakpenjualan';
    ...
    $pdf->Output('Data Laporan Penjualan.pdf', 'D');
        ...
        public function pembelian(){
            ...
            if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                ...
                $url_cetak = 'klaporan/cetakb?filter=1&tanggal='.$tgl;
                $url_cetak1 = 'klaporan/cetakpembelian?filter=1&tanggal='.$tgl;
                ...
                $url_cetak = 'klaporan/cetakb?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                $url_cetak1 = 'klaporan/cetakpembelian?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                ...
                $url_cetak = 'klaporan/cetakb?filter=3&tahun='.$tahun;
                $url_cetak1 = 'klaporan/cetakpembelian?filter=3&tahun='.$tahun;
    ...
    $this->load->view('vklappembelian', $data);
		}
    ...
    $pdf->Output('Data Laporan Pembelian.pdf', 'D');
        ...
        public function kasharian(){
            ...
            if($filter == '1'){ // Jika filter nya 1 (per tanggal)
                ...
                $ket = 'Laporan Kas pada Tanggal '.date('d-m-y', strtotime($tgl));
                $url_cetak = 'klaporan/cetakkas?filter=1&tanggal='.$tgl;
                $url_cetak1 = 'klaporan/cetakkasharian?filter=1&tanggal='.$tgl;
                ...
                $url_cetak = 'klaporan/cetakkas?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                $url_cetak1 = 'klaporan/cetakkasharian?filter=2&bulan='.$bulan.'&tahun='.$tahun;
                ...
                $url_cetak = 'klaporan/cetakkas?filter=3&tahun='.$tahun;
                $url_cetak1 = 'klaporan/cetakkasharian?filter=3&tahun='.$tahun;
                $transaksi = $this->mlapkasharian->view_by_year($tahun); // Panggil fungsi view_by_year yang ada di TransaksiModel
            }
        }else{ // Jika user tidak mengklik tombol tampilkan
            $ket = 'Laporan Kas';
            $url_cetak = 'klaporan/cetakkas';
            $url_cetak1 = 'klaporan/cetakkasharian';
    ...
    $this->load->view('vkkasharian', $data);
		}
